    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            ColumnLayout { 
                ...
                TextField { id: cvvInput; Layout.preferredWidth: 90; Layout.preferredHeight: 45; font.pixelSize: 16; color: "white"; background: Rectangle { color: "#303946"; radius: 10; border.color: "white"; border.width: 1 } }
            }
            ColumnLayout { 
                spacing: 5
