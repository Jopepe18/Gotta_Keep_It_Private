...
Window {
    ...
    signal saved(string title, string username, string password, string website, string note)
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Button {
                ...
                Layout.preferredWidth: 140
                Layout.preferredHeight: 45
                background: Rectangle { color: "#5093E9"; radius: 20 }
                contentItem: Text { text: parent.text; color: "white"; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter }
                onClicked: {
                    root.saved(titleInput.text, usernameInput.text, passwordInput.text, websiteInput.text, noteInput.text)
                    root.close()
                }
            }
        }
